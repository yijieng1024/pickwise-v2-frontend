  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminPageHeader
        crumbs={["Benchmarks"]}
        title="Benchmarks"
        description="CPU/GPU PassMark scores that feed PickScore's performance factors."
      />
  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-bold tracking-tight">CPU benchmarks</h2>
...
function GpuSection() {
  ...
  return (
    <section className="flex flex-col gap-3">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-bold tracking-tight">GPU benchmarks</h2>
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={runScraper} disabled={scraping}>
            <PlayCircle className="size-3.5" />
            {scraping ? "Starting…" : "Run PassMark scraper"}
