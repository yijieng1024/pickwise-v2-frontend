  ...
  return (
    <div className="relative mx-auto w-full max-w-[640px]">
      <input
        ...
        className="border-line bg-surface h-16 w-full rounded-full border pr-[72px] pl-7 text-[17px] shadow-[0_12px_40px_var(--shadow)] outline-none transition-shadow focus:shadow-[0_12px_40px_var(--shadow),0_0_0_3px_var(--brand-tint)]"
      />
      <button
        type="button"
        aria-label="Ask Pico"
